export const Homepage = () => (
  <div className='container d-flex flex-column align-items-center'>
    ...
    <div className='mt-5 col-10 col-lg-6'>
      ...
      <p>
        Orbit uses <strong>publicly available</strong> twitter data to determine
        who you interact with the most. That's why there's{' '}
      ...
      <p>
        People are sorted into circles by their total scores, with higher scores
      ...
      <p>
        Once your data has loaded, you are free to adjust the layout by changing
        the number of circles, as well as how many people appear in each circle.
      </p>
      <p>
